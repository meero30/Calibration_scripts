...
def run_calibration_ransac(datastore, hyperparam_dict, img, img_width, img_height, confidence = 0.7, run_name = None, result_name = None, use_init = True, skip_frame = 1, max_len = 1000, min_size = 0, line_amount = 50, plot_scale = 1, sort = 0, cond_tolerance = 20000, search_upper  = 5000, search_lower = 0, ransac_search_step = 50, post_ransac_search_step = 100, f_init = None, save_dir = 'CalibSingleFromP2D', plotting_true = False):
    '''
    ...
    '''
    # if os.path.isdir(save_dir + '/plots') == False:
    ...
    # if os.path.isdir(save_dir + '/plots/all_' + run_name) == False:
    #     os.mkdir(save_dir + '/plots/all_' + run_name)
